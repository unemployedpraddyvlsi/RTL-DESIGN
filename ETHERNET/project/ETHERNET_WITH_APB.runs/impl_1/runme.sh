...
HD_PWD='/home/krisemi_satcom/ETHERNET/project/ETHERNET_WITH_APB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eth_top.tcl -notrace
