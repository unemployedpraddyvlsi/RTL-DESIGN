...
HD_PWD='/home/krisemi_satcom/ETHERNET/local_project/ethernet_with_apb/ethernet_with_apb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_top.tcl
