...
class sequence_related_to_no_pre_ifg extends uvm_sequence#(sequence_item);

	`uvm_object_utils(sequence_related_to_no_pre_ifg)														//=========== 																									FACTORY REGISTRATION ===========
	...
	task body();																//============ RANDOMIZING THE STIMULUS ==========
		...
		begin
			...
			//total_configuration('hC,0,'h0000ABCD,1,15,'h000f,'h0034c000,'h0000c002);		//NO_PREAMBLE_ENABLE_TEST5292032

			//total_configuration('hC,0,'h0000ABCD,1,15,0,'h0034c000,'h0000c006);		//NO_PREAMBLE_NOT_ENABLE_TEST  23117824   COMPLETED

			//total_configuration('hC,0,'h0000ABCD,2,15,0,'h0034c000,'h0000c002);		//IFG_ENABLE_TEST

			//total_configuration('hC,0,'h0000ABCD,2,15,0,'h0034c000,'h0000c042);		//IFG_NOT_ENABLE_TEST
